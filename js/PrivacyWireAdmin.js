...
Sortable.mount(Remove, Revert);var createElement = function createElement(options) {
  var el, a, i;
...
var load = function load() {
  var cookiesFieldWrapper = document.querySelector("#wrap_Inputfield_cookies");

  if (cookiesFieldWrapper) {
    var cookiesField = document.querySelector("input#Inputfield_cookies");
    var cookies = cookiesField.value ? JSON.parse(cookiesField.value) : [{
      name: 'necessary',
      title: 'Necessary',
      cookies: ''
    }, {
    ...
    var cookieList = document.querySelector(".priw-cookie-list");
    ...
    if (cookies) {
      ...
      var sortable = Sortable.create(cookieList);
    }
  }
};
